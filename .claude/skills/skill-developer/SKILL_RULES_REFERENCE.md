...
| `enforcement` | string | Yes | "block", "suggest", or "warn". In this repo, the active hook wiring is suggestion-first unless you add explicit blocking hooks. |
| `priority` | string | Yes | "critical", "high", "medium", or "low" |
| `promptTriggers` | object | Optional | Triggers for UserPromptSubmit hook |
| `fileTriggers` | object | Optional | File-based hints for hooks or local workflow logic |
