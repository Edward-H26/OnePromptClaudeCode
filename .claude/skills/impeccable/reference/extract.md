...
**CRITICAL**: If no design system exists, STOP and use the harness's structured question tool when one exists, otherwise ask directly in chat, to clarify what you cannot infer. before creating one. Understand the preferred location and structure first.
