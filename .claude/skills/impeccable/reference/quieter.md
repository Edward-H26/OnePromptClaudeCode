...
If any of these are unclear from the codebase, STOP and use the harness's structured question tool when one exists, otherwise ask directly in chat, to clarify what you cannot infer.
