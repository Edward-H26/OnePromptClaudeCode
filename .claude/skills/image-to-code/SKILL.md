...
Prioritize section clarity and extraction accuracy over compact multi-section composition.
...
When the environment supports image generation plus implementation, default to an image-first workflow for website design tasks.
...
17. Have too many sections been compressed into one tiny image?
