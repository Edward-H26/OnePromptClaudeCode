...
3. Reuse existing tokens, components, and layout primitives before adding new ones.
...
3. Use the `frontend-design` plugin only when the task truly needs stronger visual direction.
